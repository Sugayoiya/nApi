package kono.ene.napi.aspect;

import cn.hutool.core.util.StrUtil;
import kono.ene.napi.annotation.FrequencyControl;
import kono.ene.napi.exception.BusinessException;
import kono.ene.napi.exception.CommonErrorEnum;
import kono.ene.napi.util.RedisUtils;
import kono.ene.napi.util.RequestHolder;
import kono.ene.napi.util.SpElUtils;
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(kono.ene.napi.annotation.FrequencyControl)||@annotation(kono.ene.napi.annotation.FrequencyControlContainer)")
