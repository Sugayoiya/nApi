...
public class NintendoSplatoonController extends AbstractBaseController {
    ...
    public PlayerStatsSimpleResponse get_player_stats_simple(@RequestParam Long qid) {
    ...
    public PlayerStatsFullResponse get_player_stats_full(@RequestParam Long qid) {
    ...
    public SalmonRunStatsResponse get_salmon_run_stats(@RequestParam Long qid) {
    ...
    public CurrentSplatfestResponse get_current_splatfest(@RequestParam Long qid) {
    ...
    public SplatFestListResponse get_splatfest_list(@RequestParam Long qid) {
    ...
    public WeaponStatsResponse get_weapon_stats(@RequestParam Long qid) {
    ...
    // get_fits
    @GetMapping("/fits")
    public FitsResponse get_fits(@RequestParam Long qid) {
    ...
    public MapsStatsResponse get_maps_stats(@RequestParam Long qid) {
    ...
    public StoreItemsResponse get_store_items(@RequestParam Long qid) {
    ...
    public StoreOrderResponse do_store_order(@RequestParam Long qid, @RequestParam String id, @RequestParam Boolean confirm) {
    ...
    public SinglePlayerStatsResponse get_single_player_stats(@RequestParam Long qid) {
    ...
    public SpeciesCurWeaponResponse get_species_cur_weapon(@RequestParam Long qid) {
    ...
    public SrHistoryListResponse get_sr_history_list(@RequestParam Long qid) {
    ...
    public SrHistoryDetailResponse get_sr_history_detail(@RequestParam Long qid, @RequestParam String id) {
    ...
    public OutfitsCommonDataResponse get_outfits_common_data(@RequestParam Long qid) {
    ...
    public ReplayListResponse get_replay_list(@RequestParam Long qid) {
